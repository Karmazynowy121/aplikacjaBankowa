...
namespace Bank
{
    public class BankManager
    {
        ...
        private void TransferFunds()
        {
            ...
            Console.WriteLine("Transfer pieniędzy");
            Console.Write("Numer konta: ");
            Console.Write("Numer konta: ");
            fromAccountId = Console.ReadLine();
            toAccountId = Console.ReadLine();
            Console.Write("Kwota: ");
            transferAmount = decimal.Parse(Console.ReadLine());
            _accountsManager.TransferFunds(fromAccountId,toAccountId,transferAmount);

            Account account = _accountsManager.GetAccount(fromAccountId);
            _ = _accountsManager.GetAccount(toAccountId);
            _printer.Print(account);
